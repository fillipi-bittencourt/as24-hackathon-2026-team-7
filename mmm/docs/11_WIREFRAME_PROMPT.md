...
**Task:** Produce a Streamlit wireframe specification for a Marketing Mix Modeling data product. The app has 6 sidebar steps and answers three executive questions: What is happening, why is it happening, and what should leadership do next.

**Context:**
- target variable: leads
- success metric: cost per lead
- models: OLS, Ridge, Lasso, ElasticNet, PyMC
- sidebar flow: Data → Config → Priors → Fit → Results → AI
- the sidebar step menu is always visible and uses message-based gating
...
**Deliverable:** A wireframe or component map that shows every widget and major metric above in the correct step and order. Use the current terminology and current 7-step sidebar architecture. Do not output Python code.
